...
class Techclub extends StatefulWidget {
  const Techclub({super.key});

  @override
  State<Techclub> createState() => _TechclubState();
}

class _TechclubState extends State<Techclub> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: const Text(
                  'Welcome to the Tech Club! We explore the latest in technology, coding, and innovation. Join us to stay ahead in the tech world and work on exciting projects.',
            ...
            StreamBuilder<DocumentSnapshot>(
              stream:
                  _firestore.collection('techclub').doc('footer').snapshots(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CircularProgressIndicator());
                } else if (snapshot.hasError) {
